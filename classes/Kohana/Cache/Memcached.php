...
class Kohana_Cache_Memcached extends Cache implements Kohana_Cache_Arithmetic {
    ...
    protected function __construct(array $config)
    {
        ...
        if (empty($servers))
        {
            ...
            throw new Cache_Exception('no Memcached servers in config/cache.php');
        }
	...
	{
		return $this->_memcached_instance->increment($id, $step);
	}
	...
	{
		return $this->_memcached_instance->decrement($id, $step);
	}
}
